...
class TestLoadForEdit:
    def test_load_returns_registro_and_items(
        ...
        result = service.save(
            ...
            paciente_name=paciente.name,
            malote_id=malote.id,
            items=[(catalog_items[0].id, 1, "", 0), (catalog_items[2].id, 1, "", 0)],
        )
...
class TestDoubleSaveWorkflow:
    ...
    def test_save_then_save_more_items_same_triple(
        ...
        r2 = service.save(
            ...
            paciente_name="Maria Santos",
            malote_id=malote.id,
            items=[(catalog_items[0].id, 1, "", 0), (catalog_items[1].id, 1, "", 0)],
            edit_id=None,
        )
    ...
    def test_three_saves_progressive_items(self, service, db, malote, catalog_items):
        ...
        r2 = service.save(
            ...
            paciente_name="Maria Santos",
            malote_id=malote.id,
            items=[(ids[0], 1, "", 0), (ids[1], 1, "", 0)],
        )
        r3 = service.save(
            tipo="entrada",
            paciente_name="Maria Santos",
            malote_id=malote.id,
            items=[(ids[0], 1, "", 0), (ids[1], 1, "", 0), (ids[2], 1, "", 0)],
        )
...
class TestComplexWorkflows:
    ...
    def test_two_patients_same_tipo_same_malote(
        ...
        r_b2 = service.save(
            ...
            paciente_name="Bob",
            malote_id=malote.id,
            items=[(catalog_items[1].id, 1, "", 0), (catalog_items[3].id, 1, "", 0)],
        )
